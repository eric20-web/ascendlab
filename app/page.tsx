...
<button className="mt-6 w-full rounded-full bg-white py-3 font-bold text-black transition hover:bg-gray-200">
  Add to<a
  href="/cart"
  className="mt-6 block w-full rounded-full bg-white py-3 text-center font-bold text-black transition hover:bg-gray-200"
>
  Add to Cart
</a> Cart
</button>
